...
import ac.id.unikom.codelabs.radio.databinding.ItemProgramTodayBinding
...
class ProgramTodayAdapter : ListAdapter<Program, ProgramTodayAdapter.ViewHolder>(
    ProgramTodayAdapterDiffCallback()
) {
