package ac.id.unikom.codelabs.radio.utilities.extensions
...
fun View.showCustomSnackBarRes(
    message: Int,
    millisDuration: Long = 5000,
    showAction: Boolean = true,
    actionMessageRes: Int = R.string.text_close
) {
...
fun View.showCustomSnackBar(
    ...
    millisDuration: Long = 5000,
    showAction: Boolean = true,
    actionMessage: String = context.getString(R.string.text_close)
) {
