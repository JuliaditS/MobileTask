...
import ac.id.unikom.codelabs.radio.databinding.ItemAnnouncerBinding

class ProgramDetailAdapter : ListAdapter<Crew, ProgramDetailAdapter.ViewHolder>(
    AnnouncerDiffCallback()
) {
